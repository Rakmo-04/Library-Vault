            ...
            <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton1">
              ...
              <li onClick={() => categoryField("FE")}>
                <button
                  ...
                  onClick={() =>
                    setSearchUrl(
                      "/search/findByCategory?category=Front End&page=0&size=5"
                    )
                  }
                >
                  Front End
              ...
              <li onClick={() => categoryField("BE")}>
                <button
                  ...
                  onClick={() =>
                    setSearchUrl(
                      "/search/findByCategory?category=Back End&page=0&size=5"
                    )
                  }
                >
                  Back End
              ...
              <li onClick={() => categoryField("Data")}>
                <button
                  ...
                  onClick={() =>
                    setSearchUrl(
                      "/search/findByCategory?category=Data&page=0&size=5"
                    )
                  }
                >
                  Data
              ...
              <li onClick={() => categoryField("DevOps")}>
                <button
                  ...
                  onClick={() =>
                    setSearchUrl(
                      "/search/findByCategory?category=DevOps&page=0&size=5"
                    )
                  }
                >
                  DevOps
