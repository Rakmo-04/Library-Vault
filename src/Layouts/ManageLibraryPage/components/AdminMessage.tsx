...
export const AdminMessage:React.FC<{message:MessageModel,
    ...
    function submitBtn(){
        if(props.message.id !== null && response !==''){
            props.submitResponseToQueston(props.message.id,response);
    ...
    return(
        <div key={props.message.id}>
            <div className="card mt- shadow p-3 bg-body rounded">
                ...
                <div>
                    ...
                    <form action='PUT'>
                        ...
                        <div className="col-md-12 mb-3">
                            ...
                            <textarea className="form-control" id="exampleFormControlledTextarea1"
                            rows={3} onChange={e=>setResponse(e.target.value)} value={response}>

                            </textarea>
                        </div>
                        <div>
                            <button type="button" className="btn btn-primary" onClick={submitBtn}>
                                Submit Response
                            </button>
                        </div>
                    </form>
