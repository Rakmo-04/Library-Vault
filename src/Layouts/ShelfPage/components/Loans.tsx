                            ...
                            <div className="card-body">
                                <div className="mt-3">
                                    ...
                                    <p className="text-secondary">
                                       Due in {shelfCurrentLoan.daysLeft} </p>}
                                       {shelfCurrentLoan.daysLeft===0 &&
                                       ...
                                       <div className="list-group mt-3 ">
                                            <button className="list-group-item list-group-item-action" aria-current='true' data-bs-toggle='model' data-bs-target={`#modals${shelfCurrentLoan.book.id}`}>
                                                Manage Loan
