...
import com.LibVault.spring_boot_library.dao.HistoryRepository;
import com.LibVault.spring_boot_library.entity.Book;
import com.LibVault.spring_boot_library.entity.Checkout;
import com.LibVault.spring_boot_library.responsemodels.ShelfCurrentLoansResponse;
import com.LibVault.spring_boot_library.entity.History;
...
public class BookService {
	...
	public List<ShelfCurrentLoansResponse> currentLoans(String userEmail) throws Exception{
		...
		for(Checkout check : checkoutList) {
			bookIdList.add(check.getBookId());
		}
